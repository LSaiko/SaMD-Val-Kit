...
Examples:
  ...
  Run all demos:
    ...
    parser.add_argument(
        "command", choices=["demo", "version", "standards"], help="Command to run"
    )
    parser.add_argument(
        "--class",
        dest="device_class",
...
def print_standards_reference():
    standards = [
        ...
        (
            "FDA SaMD Guidance",
            "Software as a Medical Device — Clinical Evaluation (2017)",
        ),
        ...
        (
            "IMDRF N10/N12/N23",
            "SaMD Framework, Risk Categorization, Clinical Evaluation",
        ),
