...
class IEC62304LifecycleValidator:
    ...
    LIFECYCLE_ACTIVITIES: List[LifecycleActivity] = [
        ...
        LifecycleActivity(
            "5.1",
            "Software Safety Class Assignment",
            required_for_class=["A", "B", "C"],
        ...
        LifecycleActivity(
            "5.3",
            "Segregation of Safety-Critical Components",
        ...
        LifecycleActivity(
            "5.7",
            "System Test Execution and Results",
            required_for_class=["A", "B", "C"],
    ...
    def required_activities(self) -> List[LifecycleActivity]:
        ...
        return [
            a for a in self.LIFECYCLE_ACTIVITIES if a.is_required_for(self.safety_class)
        ]
    ...
    def gap_analysis(
        ...
        return {
            ...
            "Gaps": len(gaps),
            "Compliance": (
                f"{(len(done) / len(required) * 100):.0f}%" if required else "100%"
            ),
    ...
    def print_checklist(self):
        ...
        required = self.required_activities()
        print("\n" + "=" * 70)
        print("IEC 62304:2006+AMD1:2015 COMPLIANCE CHECKLIST")
