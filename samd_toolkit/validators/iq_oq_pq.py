...
class PerformanceQualification:
    ...
    def _build_protocol(self):
        ...
        self._add(
            ...
            criteria="System restored to full operation within RTO; data loss ≤ RPO; all audit trails intact",
        ...
        if d.contains_ai_ml:
            self._add(
                "PQ-008",
                "AI/ML Production Monitoring Baseline",
